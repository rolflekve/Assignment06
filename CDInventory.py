...
# Gleque, 2022-11-19, Edited file
# Gleque, 2022-11-20, Edited file
#------------------------------------------#
...
class IO:
    ...
    def addnew_cd():
        ...
        lstTbl = [strID, strTitle, strArtist]
        return lstTbl
...
while True:
    ...
    # 3.3 process add a CD
        ...
        strID, strTitle, strArtist = IO.addnew_cd()
